    ...
    <div className='p-6 md:grid md:grid-cols-3 gap-10'>
      <div className='rounded-xl shadow-2xl p-10 text-center bg-slate-100 my-8'>
        ...
        <p className='text-gray-700  tracking-wide '>
          I am a dedicated, organized and methodical individual. I have good interpersonal
          skills, I'm an excellent team worker, keen and very willing to learn and develop
          new skills. I am reliable and dependable and often seek new responsibilities
          within a wide range of employment areas. I have an active and dynamic approach
          to work and getting things done. I am determined and decisive.
        </p>
      ...
      <div className='rounded-xl shadow-2xl p-10 text-center bg-slate-100 my-8'>
        ...
        <h4 class='text-orange-500 text-lg p-2 font-rob '>Design tools I use</h4>
